...
# Our hypotheses are paired because we are comparing the means of democracies and
...
## Yes our data is paired, it is paired because we have two potential outcomes 
## a country that is a democracy or is a non-democracy (autocracy), and both
## outcomes are realized in our dataset. 
